    ...
    while True:
        if Start:
            ...
            try:
                ...
                f = open("/home/pi/NAS/LC.log", "a")
                f.write("\n" + "LC5.3.py started at: " + timestr + "  Loop: " + str(data))
                f.close()
            except:
                f = open("/home/pi/data/LC.log", "a")
                f.write("\n" + "network error, LC5.3.py started without NAS at: " + timestr + "  Loop: " + str(data))
                f.close()
                print("NAS not mounted, started LC5.3.py without NAS")
            Start = False
        try:
